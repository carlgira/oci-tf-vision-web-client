...
resource oci_core_security_list subnet-sl-public {
  compartment_id = var.compartment_ocid
...
resource oci_core_subnet public-subnet {
  ...
  security_list_ids   = [oci_core_security_list.subnet-sl-public.id]
...
resource oci_core_security_list subnet-sl-private {
  compartment_id = var.compartment_ocid
...
resource oci_core_subnet private-subnet {
  ...
  security_list_ids          = [oci_core_security_list.subnet-sl-private.id]
  dhcp_options_id            = oci_core_vcn.vcn.default_dhcp_options_id
